...
<title>cilicili-论坛</title>
<link href="<%=request.getContextPath()%>/static/Forum/css/bootstrap.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/static/Forum/css/bootstrap-responsive.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/static/Forum/css/application.css" rel="stylesheet">
<script src="<%=request.getContextPath()%>/static/Forum/js/jquery.js" type="text/javascript"></script>
<style type="text/css">
.fastlg_fm {
	float: left;
	clear: right;
...
<body>
                ...
                <div class="well well-small pull-right user-panel-mini">
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.userName==''||sessionScope.userName==null}">
							<%-- 实现登陆 --%>
                            <form action="/articleShowAll.action" method="post">
                                <div class="controls controls-row">
                                    <input class="input-medium" type="text" name="username" id="ls_username" class="px vm xg1" placeholder="用户名"
											tabindex="901" />
                                ...
                                <ul class="nav nav-pills" style="margin-bottom: 0px">
                                    <li><a href="/register.action" class="xi2 xw1" style="color: #000000; font-size: 14px">立即注册</a></li>
                                    <li><li class="pull-right" style="padding-top: 4px;">

                                    <label class="checkbox" style="margin-right: 10px; float: left; margin-top: 4px;">
                        ...
                        <c:when test="${sessionScope.userName!=''||sessionScope.userName!=null}">
                            ...
                            <div>
                                <a href="/index.action" class="xi2 xw1" style="color: #000000; font-size: 14px">返回首页</a>
                                <a href="/articleIndex.action" class="xi2 xw1" style="color: #000000; font-size: 14px">返回论坛</a>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <form action="/loginService.action" method="get">
                                <div class="controls controls-row">
                                    <input class="input-medium" type="text"
                                           name="username" id="ls_username" class="px vm xg1" placeholder="用户名" tabindex="901" /> <input class="input-medium" placeholder="密码" type="password" name="password" id="ls_password" class="px vm" autocomplete="off" tabindex="902" />
                                </div>
                                <ul class="nav nav-pills" style="margin-bottom: 0px">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-left" tabindex="904" style="width: 75px;">登录</button></li>
                                </ul>
                            </form>
    ...
    <div class="container">
			...
			<div class="navbar-inner ">
				<div class="container ">
                    ...
                    <div class="nav-collapse collapse ">
                        <ul class="nav ">
                            <li class="active " id="mn_forum "><a href="/articleIndex.action" hidefocus="true " title="BBS ">论坛<span>BBS</span></a></li>
							<li class="active " id="mn_forum "><a href="/index.action" hidefocus="true " title="BBS ">首页<span>BBS</span></a></li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <div class="title-frame title-frame-big ">
            <div class="container ">
				<div id="chart " class="bm bw0 cl small-bar ">
                    <div class="chart z ">今日:
                        <em>
                        <span style="color: red">${articleTodayCount}</span>
                        </em>
                        <span class="pipe ">|</span>
                        昨日:<em>
                            <span style="color: red">${articlelastDayCount }
                            </span>
                        </em>
                        <span class="pipe ">|</span>
                        帖子: <em>
                            <span style="color: red">${articleCount }</span>
                        </em>
                        <span class="pipe ">|</span>
                        会员:
						<em>
                            <span style="color: red">${userCount}位</span>
                        </em>
						|一周内: <em>
                            <span style="color: red">${SevenDayCount}</span>
                        </em>
						<span class="pipe ">|</span>
                        欢迎新会员: <em>
                            <span style="color: red">${userNameMessage}
                            </span>
                        </em>
        ...
        <style id="diy_style " type="text/css ">
            #portal_block_71 { margin-right:0px !important;margin-bottom:8px !important;}
            #portal_block_70 {  margin-bottom:8px !important;}
        </style>
				...
				<div class=" ">
					...
					<div class="title-frame title-frame-big flg ">
						...
						<div id="category_705 " class="bm_c category " style="">
							<div class="forum-block ">
								<div class="icon ">
									<!--<br/>-->
									<a href="/articleShowAll.action"><img
										src="<%=request.getContextPath()%>/static/Forum/picture/common_343_icon.png " align="left " alt=" " /></a>
								</div>
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="color: #FF0000; font-weight: bold;">热门动漫讨论区</a>
                                        <em class="xw0 xi1 " title="今日 "> (27)</em>
									</h2>
									<p>主题:2498,&nbsp;贴数:<span title="292244 ">29万</span>
									</p>
									<p>
                            ...
                            <div class="forum-block ">
								<div class="icon ">
									<!--<br/>-->
									<a href="/articleShowAll.action">
                                        <img src="<%=request.getContextPath()%>/static/Forum/picture/common_707_icon.png " align="left " alt=" " /></a>
                                </div>
                                <div class="info ">
                                    <h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">嘀哩搞基（姬）区</a>
                                        <em class="xw0 xi1 " title="今日 "> (19)</em>
									</h2>
                                    <p>
                                        主题:5265,&nbsp;贴数:<span title="417885 ">41万</span>
									</p>
                                    <p>
										<a href="javascript:void(0);" class="xi2 ">最后:<span title="2017-8-14 16:04 ">1&nbsp;小时前</span>
										</a>
									</p>
                                </div>
							</div>
							<div class="forum-block ">
								<div class="icon ">
									<!--<br/>-->
									<a href="/articleShowAll.action">
                                        <img src="<%=request.getContextPath()%>/static/Forum/picture/common_709_icon.png " align="left " alt=" " /></a>
								</div>

								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">嘀哩嘀哩资源区</a><em
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">嘀哩嘀哩报错寻番</a><em
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">FAQ反馈建议</a>
									</h2>
									<p>主题:171,&nbsp;贴数:1563</p>
									<p>
										<a href="javascript:void(0);" class="xi2 ">最后:<span
					...
					<div class="title-frame title-frame-big flg ">
						<div class="title ">
							...
							<h2>
								<a href="/articleShowAll.action" style="">ACG资源</a>
							</h2>
						</div>
						<div id="category_594 " class="bm_c category " style="">
							<div class="forum-block ">
								<div class="icon ">
									<!--<br/>-->
									<a href="/articleShowAll.action">
                                        <img src="<%=request.getContextPath()%>/static/Forum/picture/common_557_icon.png " align="left " alt=" " /></a>
                                </div>
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">D站评论</a><em
					...
					<div class="title-frame title-frame-big flg ">
						<div class="title ">
							...
							<h2>
								<a href="/articleShowAll.action" style="">手游专区</a>
							</h2>
						</div>
						<div id="category_755 " class="bm_c category " style="">
							<div class="forum-/articleShowAll.action ">
								<div class="icon ">
									<!--<br/>-->
									<a href="/articleShowAll.action"><img
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">死神斩魂</a>
									</h2>
									<p>主题:11,&nbsp;贴数:23</p>
									<p>
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">阴阳师手游</a>
									</h2>
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">甲铁城的卡巴内瑞</a>
									</h2>
					...
					<div class="title-frame title-frame-big flg ">
                        <div class="title ">
							...
							<h2>
								<a href="/articleShowAll.action" style="">站务管理</a>
							</h2>
						</div>
						<div id="category_8 " class="bm_c category " style="">
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">官方通告</a>
									</h2>
							...
							<div class="forum-block ">
								...
								<div class="info ">
									<h2>
										<a href="/articleShowAll.action" style="font-weight: bold;">申请事务所</a>
									</h2>
									<p>主题:1010,&nbsp;贴数:3997</p>
									<p>最后:从未</p>
								</div>
