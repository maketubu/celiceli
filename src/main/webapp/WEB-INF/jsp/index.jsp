...
<body>
		...
		<div class="header-top">
			<div class="page-width clearfix">
				<div class="header-top__nav">
					<ul>
						<li class="item item-home"><a href="/index.action">主站</a></li>
						<!-- <li class="item"><a href="Shopping.sf">周边</a></li> -->
						<li class="item"><a href="/index.action">商品购买</a>
						<li class="item"><a href="/videoFileTop.action">我要投稿</a>
						<li class="item"><a href="/articleIndex.action">进入论坛</a></li>
					</ul>
				</div>
				...
				<div class="header-top__user">
					...
					<div class="login-box">
						<a href="/login.action">登录</a> <span></span> <a href="/register.action">注册</a>
					</div>
				...
				<div class="header-top__user"
					 ...
					 id="div2">
					<%-- hover 位置--%>
					<div class="hideInfoList" onmouseout="asjdh()">
						<div id="kawayi">
							<div style="width: 130px; height: 160px; background-color: red; position: fixed; margin-left: 14%">
								...
								<div style="width: 90px; height: 90px; margin-top: -113px; margin-left: -110px">
									...
									<img style="width: 90px; height: 80px" alt=""
										 src="<%=request.getContextPath()%><%=request.getSession().getAttribute("userHeadPic")%>">
								</div>
							</div>
						</div>
						...
						<%-- 个人信息栏 --%>
						<div >
							<br> <a href="" style="color: red">个人信息</a>&nbsp;&nbsp;
							<a href="/userInformation.action" style="color: red">修改密码</a>&nbsp;&nbsp;
							<a href="/userInformation.action" style="color: red">修改头像</a><br>
							<div style="background-color: black">------------------------</div>
							<br> <a href="/exchangeUser.action" style="margin-left: 23%">切换用户</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="page-width clearfix">
		<ul class="nav-list">
			<li class="item item-home"><a href="/index.action" class="link">首页</a>
			</li>
			<li class="item"><a href="testshabi.action" class="link">
					<div class="num">
						<i>887</i>
					</div> 动画
			</a></li>
			...
			<li class="item item-square"><a href="testshabi.action" class="link">广场</a>
	...
	<div id="banner">
		<div class="page-width clearfix">
			...
			<div class="banner-list fr">
				<ul>
					<c:forEach items="${listRandom6}" var="fuck">
						<li><a
                                href="/videoShow.action?addr=${fuck.videoAddress}&videoID=${fuck.videoID}">
                            <%-- 访问视频展示页 --%>
			...
			<div class="mainCont clearfix" id="dance" js-move="true">
				<div class="pic-list fl" js-tab="true">
					...
					<ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
						<!-- 这里开始遍历 -->
						<c:forEach items="${listType1}" var="list">
							<li class="item"><a
								href="/videoShow.action?addr=${list.videoAddress}&videoID=${list.videoID}"
								class="img-link">
								<img src="<%=request.getContextPath()%>${list.videoImage}" alt="#">
								<span class="mask"></span> <span class="time">${list.videoTime}</span>
							</a>
								<div class="img-info">
									<a href="/videoShow.action?addr=${list.videoAddress}&videoID=${list.videoID}">${list.videoName }</a>
									<div class="btm">
										<div class="user">
											<i></i>admin
										</div>
			...
			<div class="mainCont clearfix" id="game" js-move="true">
				<div class="pic-list fl" js-tab="true">
					...
					<ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
						...
						<c:forEach items="${listType2}" var="list2">
							<li class="item"><a
								href="/videoShow.action?addr=${list2.videoAddress}&videoID=${list2.videoID}"
								class="img-link"> <img
								...
								<div class="img-info">
									<a
										href="/videoShow.action?addr=${list2.videoAddress}&videoID=${list2.videoID}">${list2.videoName }</a>
									<div class="btm">
										<div class="user">
											<i></i>admin
										</div>
			...
			<div class="mainCont clearfix" id="technology" js-move="true">
				<div class="pic-list fl" js-tab="true">
					...
					<ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
						...
						<c:forEach items="${listType3}" var="list3">
							<li class="item"><a
								href="/videoShow.action?addr=${list3.videoAddress}&videoID=${list3.videoID}"
								class="img-link"> <img
								...
								<div class="img-info">
									<a
										href="/videoShow.action?addr=${list3.videoAddress}&videoID=${list3.videoID}">${list3.videoName }</a>
									<div class="btm">
										<div class="user">
											<i></i>admin
										</div>
