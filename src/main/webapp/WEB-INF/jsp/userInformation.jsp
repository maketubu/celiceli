...
<script src="<%=request.getContextPath()%>/static/User_Data_Update/js/jquery-1.8.3.min.js"></script>
<script src="<%=request.getContextPath()%>/static/User_Data_Update/js/index2.js"></script>
<script src="<%=request.getContextPath()%>/static/User_Data_Update/js/index2.js"></script>
...
<title>cilicili-用户信息</title>
</head>
<body>
	<!-- 这里是上传头像界面 -->
	<div id="dialog">
		<p class="close">
			<a href="/userInformation.action" onclick="closeBg();">关闭</a>
		</p>
		<!-- <div>正在加载，请稍后....</div> -->
		<div>
			<form method="post" action="UploadServlet" enctype="multipart/form-data">
				...
				<input type="submit" id="sid" value="上传" />
			</form>
		</div>
		进度条
	</div>
	...
	<div class="centers_m">
		...
		<!--侧边服务列表-->
			<div class="centers_listm">
				<div class="centers_listm_one">
					<img src="<%=request.getContextPath()%>/static/User_Data_Update/images/zshy.png" />
					<em>会员中心</em>
				</div>
			<!--一条开始-->
			...
			<span class="gjszmdm"> <a href="javascript:showBg();" class="center_in_self"><font id="shangchuan">上传头像</font></a> <!-- <input type="submit" id="sid" class="center_in_self" value="上传头像" /> -->
				<a href="/userInformation.action" class="center_in_self"><font>信息资料</font></a>
				<a href="/userInformation.action" class="center_in_self"><font>银行卡管理</font></a>
				<a href="/userInformation.action" class="center_in_self"><font>收货地址管理</font></a>
			</span>
			<!--一条开始-->
			<div class="centers_listm_one_in">
			...
			<span class="gjszmdm"> <a href="/userInformation.action" class="center_in_self"><font>我的订单</font></a>
				<a href="/userInformation.action" class="center_in_self"><font>已删除订单</font></a>
				<a href="javascript:return false;" class="center_in_self"><font>订单投诉</font></a>
			</span>
		...
		<div class="centers_mr">
			<h1 class="welcom_tm">
				欢迎您，超级会员
				<font><%=request.getSession().getAttribute("userName")%>
				</font>！您上次登录时间为 2019-3-17
				<div class="gezhong_szm_in" style="margin-top: -50px;margin-left: 40px">
					<a href="/exchangeUser.action">切换账号</a>
					<a href="/videoFileTop.action">我要投稿</a>
				</div>
			</h1>
			<!--一条开始-->
			...
			<div class="public_m1">
				...
				<div class="gezhong_szm">
					...
					<div class="gezhong_szm_in">
						<b style=" background:url(<%=request.getContextPath()%>/static/User_Data_Update/images/fourm.png) no-repeat 0 0"></b>
						<span>登录密码<br><em>已设置</em></span>
						<p>安全性高的密码，可以使账户更安全。建议您定期更换密码。安全性高的密码，可以使账户更安全。建议您定期更换密码。安全性高的密码，可以使账户更安全。建议您定期更换密码。</p>
						<a href="Update_login_password.action">修改密码</a>
					</div>
					<!--一条开始a-->
					<div class="gezhong_szm_in">
						<b style=" background:url(<%=request.getContextPath()%>/static/User_Data_Update/images/fourm.png) no-repeat 0 -50px"></b>
						<span>邮箱绑定<br>
						<em>Email</em></span>
						<p>进行邮箱验证后，可用于接收敏感操作的身份验证信息，以及订阅更优惠商品的促销邮件。</p>
						<a href="Update_email.action">绑定邮箱</a>
					</div>
					<!--一条开始a-->
					<div class="gezhong_szm_in">
						<b style=" background:url(<%=request.getContextPath()%>/static/User_Data_Update/images/fourm.png) no-repeat 0 -100px"></b>
						<span>手机绑定<br>
						<em>Phone</em></span>
						<p>进行手机验证后，可用于接收敏感操作的身份验证信息，以及进行积分消费的验证确认，非常有助于保护您的账号和账户财产安全。</p>
						<a href="Update_Phone.action">修改手机</a>
					</div>
					<!--一条开始a-->
					<div class="gezhong_szm_in">
						<b style=" background:url(<%=request.getContextPath()%>/static/User_Data_Update/images/fourm.png) no-repeat 0 -150px"></b>
						<span>支付密码<br><em>Password</em></span>
						<p>设置支付密码后，在使用账户中余额时，需输入支付密码。</p>
						<a href="Update_PayPassword.action">修改密码</a>
					</div>
				</div>
			</div>
		</div>
