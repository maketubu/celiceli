...
<body>
	...
	<div style="right: -230px;" class="contactusdiyou">
		<div class="hoverbtn">
			<span>联</span><span>系</span><span>我</span><span>们</span><img class="hoverimg" src="<%=request.getContextPath()%>/static/cebianlan/images/hoverbtnbg.gif" height="9" width="13">
		</div>
		<div class="conter">
			<!--	<div class="con1"> 
			<dl class="fn_cle">
			...
			<div class="qqcall">
				<dl class="fn_cle">
					<dt>
						<img src="<%=request.getContextPath()%>/static/cebianlan/images/zxkfqq.png" height="31" width="31">
					</dt>
					...
					<dd class="f2 kefuQQ">
						...
						<br>
						<span>客服二</span> <a target="_blank" href="http://shang.qq.com/open_webaio.html?sigt=6abe29a244eb227a65bc98c7bd8db390952bd95efbb3295f83d8383e3adbafd33663e0b1763171504a69aef06db7c246&sigu=53edec6635b8a65c6ebd2879cd09c64b5bf5425f269417462a92f949cec06d26fb69e1450ae26685&tuin=794799102"></a>
					</dd>
				</dl>
				<div class="blank0" ></div>
			</div>
			...
			<div class="weixincall">
				<dl class="fn_cle">
					<dt>
						<img src="<%=request.getContextPath()%>/static//cebianlan/images/weixin.png" height="31" width="31">
					</dt>
					<dd class="f1">官方微信站：</dd>
					<dd class="f3">
						<img src="<%=request.getContextPath()%>/static//cebianlan/images/erweima.png" height="73" width="73">
					</dd>
				</dl>
			</div>
			<!--<div class="blank0"></div>
	...
	<div>
		<img src="<%=request.getContextPath()%>/static/Homepage/images/bilibili.png" style="width: 100%;" />
	</div>
	<style type="text/css">
		body {
	...
	<div id="menu1" class="menu">
		<ul>
			<li><a href="/login.action">首 页</a></li>
