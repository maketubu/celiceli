...
<body style="background-image: url(<%=request.getContextPath()%>/static/register/images/test.jpg);width: 100%;height: 100%;">
	<div class='body_main'>
		<!-- start main content -->
		<div class='index_box' style='margin-top: 20px;'>
			...
			<div class='box_main'>
				<div id="register" class="register">
					<%-- 注册表单--%>
					<form id="form" action="/registerService.action" method="post" onSubmit="return check();">
						<div id="form_submit" class="form_submit">
							...
							<div class="fieldset">
								...
								<div class="field-group">
									...
									<%--填写邮箱账号--%>
								<div class="field-group">
									<label class="required title">邮箱</label> <span class="control-group" id="email_input">
										<div class="input_add_long_background">
