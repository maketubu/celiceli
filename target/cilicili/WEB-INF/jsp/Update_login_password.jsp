...
<body>
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<!--结束-->
			<div class="dao_list">
				<a href="/index.action">首页</a> <a href="javascript:return false;">视频收藏</a> <a href="/index.action">周边</a>
	...
	<div class="centers_m">
		...
		<div class="centers_ml">
			...
			<div class="centers_listm">
				...
				<span class="gjszmdm"> <a href="/userInformation.action" class="center_in_self"><font>信息资料</font></a>
					<a href="/userInformation.action" class="center_in_self"><font>银行卡管理</font></a> <a
					href="/userInformation.action" class="center_in_self"><font>收货地址管理</font></a>
				</span>
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img
				...
				<span class="gjszmdm"> <a href="/userInformation.action" class="center_in_self"><font>我的订单</font></a>
					<a href="/userInformation.action" class="center_in_self"><font>已删除订单</font></a> <a
...
<%-- 				<!--一条开始-->
		...
		<div class="public_m1">
			...
			<form action="Update_login_password.action" method="post">
				<div class="public_m4">
					<p>
