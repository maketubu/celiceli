...
<article class="htmleaf-container">
	...
	<div class="panel-lite">
		...
		<form action="/loginService.action" method="post">
			...
			<div>
				<%if(request.getAttribute("PHO")!=null) { %>
				<b style="color: red">
					<%= request.getAttribute("PHO") %>
				</b>
				<%} %>
			</div>
			<a href="#">忘记密码 ?  </a>    <a href="/register.action">立即注册? </a><br>
			<a href="/index.action">返回首页 </a>
			<button class="floating-btn" id="tijiao" type="submit"><i class="icon-arrow"></i></button>
		</form>
	</div>
</article>
</body>
